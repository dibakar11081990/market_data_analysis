'''
This python script picks and loads YOUTUBE POST Data from SPROUT API creates a equivalent csv file and puts it to S3
...
TARGET_TABLE = 'YOUTUBE_POST_DATA'
...
if os.environ['ENVIRONMENT'] == 'prd':
    key =  'sprout/dt='+date+'/youtube_post_data.csv' 
    tags_key = 'sprout/dt='+date+'/customer_tags_data.csv'

else:
    key =  'test/dt='+date+'/youtube_post_data.csv' 
...
print("YouTube Data extraction started...")
...
col_list = [
  ...
  'hashtags',
  'metrics.lifetime.annotation_click_through_rate',
  'metrics.lifetime.annotation_clickable_impressions',
  'metrics.lifetime.annotation_clicks',
  'metrics.lifetime.card_click_rate',
  'metrics.lifetime.card_clicks',
  'metrics.lifetime.card_teaser_click_rate',
  'metrics.lifetime.card_teaser_clicks',
  'metrics.lifetime.post_content_clicks_other',
  'metrics.lifetime.reactions',
  'metrics.lifetime.shares_count',
  'metrics.lifetime.likes',
  'metrics.lifetime.dislikes',
  'metrics.lifetime.comments_count',
  'metrics.lifetime.video_views',
  'metrics.lifetime.card_impressions',
  'metrics.lifetime.estimated_minutes_watched',
  'metrics.lifetime.estimated_red_minutes_watched',
  'metrics.lifetime.red_video_views',
  'metrics.lifetime.subscribers_gained',
  'metrics.lifetime.subscribers_lost',
  'metrics.lifetime.videos_added_to_playlist',
  'metrics.lifetime.videos_removed_from_playlist',
  'internal.tags',
  'perma_link'
]
...
post_df.rename(columns={
  ...
  'metrics.lifetime.annotation_click_through_rate': 'annotation_click_through_rate',
  'metrics.lifetime.annotation_clickable_impressions': 'annotation_clickable_impressions',
  'metrics.lifetime.annotation_clicks': 'annotation_clicks',
  'metrics.lifetime.card_click_rate': 'card_click_rate',
  'metrics.lifetime.card_clicks': 'card_clicks',
  'metrics.lifetime.card_teaser_click_rate': 'card_teaser_click_rate',
  'metrics.lifetime.card_teaser_clicks': 'card_teaser_clicks',
  ...
  'metrics.lifetime.dislikes': 'dislikes',
  'metrics.lifetime.comments_count': 'comments_count',
  'metrics.lifetime.video_views': 'video_views',
  'metrics.lifetime.card_impressions': 'card_impressions',
  'metrics.lifetime.estimated_minutes_watched': 'estimated_minutes_watched',
  'metrics.lifetime.estimated_red_minutes_watched': 'estimated_red_minutes_watched',
  'metrics.lifetime.red_video_views': 'red_video_views',
  'metrics.lifetime.subscribers_gained': 'subscribers_gained',
  'metrics.lifetime.subscribers_lost': 'subscribers_lost',
  'metrics.lifetime.videos_added_to_playlist': 'videos_added_to_playlist',
  'metrics.lifetime.videos_removed_from_playlist': 'videos_removed_from_playlist',
...
# doing the truncate and load of the target table in SF
    with sf_engine.begin() as connection:
        ...
        copy_into_query = f'''
        COPY INTO "{DB}"."{snowflake_schema}"."{TARGET_TABLE}"("INGESTION_TIMESTAMP", "CREATED_TIME", "CUSTOMER_PROFILE_ID", "POST_TYPE", "NETWORK", "LONG_URL", "SHORT_URL", "HASHTAGS", "ANNOTATION_CLICK_THROUGH_RATE", "ANNOTATION_CLICKABLE_IMPRESSIONS", "ANNOTATION_CLICKS", "CARD_CLICK_RATE", "CARD_CLICKS", "CARD_TEASER_CLICK_RATE", "CARD_TEASER_CLICKS", "POST_CONTENT_CLICKS_OTHER", "REACTIONS", "SHARES_COUNT", "LIKES", "DISLIKES", "COMMENTS_COUNT", "VIDEO_VIEWS", "CARD_IMPRESSIONS", "ESTIMATED_MINUTES_WATCHED", "ESTIMATED_RED_MINUTES_WATCHED", "RED_VIDEO_VIEWS", "SUBSCRIBERS_GAINED", "SUBSCRIBERS_LOST", "VIDEOS_ADDED_TO_PLAYLIST", "VIDEOS_REMOVED_FROM_PLAYLIST", "TAG_ID", "POST_URL", "TAGS")
        FROM 
                's3://{bucket}/'
    ...
    return '\n:::END OF Customer POST Data For Youtube Extract Load script:::'
