'''
This python script picks and loads Facebook POST Data from SPROUT API creates a equivalent csv file and puts it to S3
...
TARGET_TABLE = 'FACEBOOK_POST_DATA'
...
if os.environ['ENVIRONMENT'] == 'prd':
    key =  'sprout/dt='+date+'/facebook_post_data.csv' 
    tags_key = 'sprout/dt='+date+'/customer_tags_data.csv'

else:
    key =  'test/dt='+date+'/facebook_post_data.csv' 
...
col_list = [
  ...
  'metrics.lifetime.post_content_clicks_other',
  'metrics.lifetime.post_content_clicks_unique',
  'metrics.lifetime.post_link_clicks',
  'metrics.lifetime.post_link_clicks_unique',
  'metrics.lifetime.post_other_clicks_unique',
  'metrics.lifetime.post_photo_view_clicks',
  'metrics.lifetime.post_photo_view_clicks_unique',
  'metrics.lifetime.post_video_play_clicks',
  'metrics.lifetime.post_video_play_clicks_unique',
  'metrics.lifetime.reactions',
  'metrics.lifetime.reactions_angry',
  'metrics.lifetime.reactions_haha',
  'metrics.lifetime.reactions_love',
  'metrics.lifetime.reactions_sad',
  'metrics.lifetime.reactions_wow',
  'metrics.lifetime.shares_count',
  'metrics.lifetime.likes',
  'metrics.lifetime.comments_count',
  'metrics.lifetime.video_view_time',
  'metrics.lifetime.video_view_time_organic',
  'metrics.lifetime.video_view_time_paid',
  'metrics.lifetime.video_view_time_per_view',
  'metrics.lifetime.video_views',
  'metrics.lifetime.video_views_10s',
  'metrics.lifetime.video_views_10s_autoplay',
  'metrics.lifetime.video_views_10s_click_to_play',
  'metrics.lifetime.video_views_10s_organic',
  'metrics.lifetime.video_views_10s_paid',
  'metrics.lifetime.video_views_10s_sound_off',
  'metrics.lifetime.video_views_10s_sound_on',
  'metrics.lifetime.video_views_10s_unique',
  'metrics.lifetime.video_views_30s_complete',
  'metrics.lifetime.video_views_30s_complete_autoplay',
  'metrics.lifetime.video_views_30s_complete_click_to_play',
  'metrics.lifetime.video_views_30s_complete_organic',
  'metrics.lifetime.video_views_30s_complete_paid',
  'metrics.lifetime.video_views_30s_complete_unique',
  'metrics.lifetime.video_views_autoplay',
  'metrics.lifetime.video_views_click_to_play',
  'metrics.lifetime.video_views_organic',
  'metrics.lifetime.video_views_organic_unique',
  'metrics.lifetime.video_views_p95',
  'metrics.lifetime.video_views_p95_organic',
  'metrics.lifetime.video_views_p95_organic_unique',
  'metrics.lifetime.video_views_p95_paid',
  'metrics.lifetime.video_views_p95_paid_unique',
  'metrics.lifetime.video_views_paid',
  'metrics.lifetime.video_views_paid_unique',
  'metrics.lifetime.video_views_partial',
  'metrics.lifetime.video_views_partial_autoplay',
  'metrics.lifetime.video_views_partial_click_to_play',
  'metrics.lifetime.video_views_partial_organic',
  'metrics.lifetime.video_views_partial_paid',
  'metrics.lifetime.video_views_sound_off',
  'metrics.lifetime.video_views_sound_on',
  'metrics.lifetime.video_views_unique',
  'metrics.lifetime.impressions',
  'metrics.lifetime.impressions_follower',
  'metrics.lifetime.impressions_follower_unique',
  'metrics.lifetime.impressions_nonfollower',
  'metrics.lifetime.impressions_nonviral',
  ...
  'metrics.lifetime.impressions_viral',
...
post_df.rename(columns={
  ...
  'metrics.lifetime.post_content_clicks_other': 'post_content_clicks_other',
  'metrics.lifetime.post_content_clicks': 'post_content_clicks',
  'metrics.lifetime.post_content_clicks_unique': 'post_content_clicks_unique',
  'metrics.lifetime.post_link_clicks': 'post_link_clicks',
  'metrics.lifetime.post_link_clicks_unique': 'post_link_clicks_unique',
  'metrics.lifetime.post_other_clicks_unique': 'post_other_clicks_unique',
  'metrics.lifetime.post_photo_view_clicks': 'post_photo_view_clicks',
  'metrics.lifetime.post_photo_view_clicks_unique': 'post_photo_view_clicks_unique',
  'metrics.lifetime.post_video_play_clicks': 'post_video_play_clicks',
  'metrics.lifetime.post_video_play_clicks_unique': 'post_video_play_clicks_unique',
  'metrics.lifetime.reactions': 'reactions',
  'metrics.lifetime.reactions_angry': 'reactions_angry',
  'metrics.lifetime.reactions_haha': 'reactions_haha',
  'metrics.lifetime.reactions_love': 'reactions_love',
  'metrics.lifetime.reactions_sad': 'reactions_sad',
  'metrics.lifetime.reactions_wow': 'reactions_wow',
  'metrics.lifetime.shares_count': 'shares_count',
  'metrics.lifetime.likes': 'likes',
  'metrics.lifetime.comments_count': 'comments_count',
  'metrics.lifetime.video_view_time': 'video_view_time',
  'metrics.lifetime.video_view_time_organic': 'video_view_time_organic',
  'metrics.lifetime.video_view_time_paid': 'video_view_time_paid',
  'metrics.lifetime.video_view_time_per_view': 'video_view_time_per_view',
  'metrics.lifetime.video_views': 'video_views',
  'metrics.lifetime.video_views_10s': 'video_views_10s',
  'metrics.lifetime.video_views_10s_autoplay': 'video_views_10s_autoplay',
  'metrics.lifetime.video_views_10s_click_to_play': 'video_views_10s_click_to_play',
  'metrics.lifetime.video_views_10s_organic': 'video_views_10s_organic',
  'metrics.lifetime.video_views_10s_paid': 'video_views_10s_paid',
  'metrics.lifetime.video_views_10s_sound_off': 'video_views_10s_sound_off',
  'metrics.lifetime.video_views_10s_sound_on': 'video_views_10s_sound_on',
  'metrics.lifetime.video_views_10s_unique': 'video_views_10s_unique',
  'metrics.lifetime.video_views_30s_complete': 'video_views_30s_complete',
  'metrics.lifetime.video_views_30s_complete_autoplay': 'video_views_30s_complete_autoplay',
  'metrics.lifetime.video_views_30s_complete_click_to_play': 'video_views_30s_complete_click_to_play',
  'metrics.lifetime.video_views_30s_complete_organic': 'video_views_30s_complete_organic',
  'metrics.lifetime.video_views_30s_complete_paid': 'video_views_30s_complete_paid',
  'metrics.lifetime.video_views_30s_complete_unique': 'video_views_30s_complete_unique',
  'metrics.lifetime.video_views_autoplay': 'video_views_autoplay',
  'metrics.lifetime.video_views_click_to_play': 'video_views_click_to_play',
  'metrics.lifetime.video_views_organic': 'video_views_organic',
  'metrics.lifetime.video_views_organic_unique': 'video_views_organic_unique',
  'metrics.lifetime.video_views_p95': 'video_views_p95',
  'metrics.lifetime.video_views_p95_organic': 'video_views_p95_organic',
  'metrics.lifetime.video_views_p95_organic_unique': 'video_views_p95_organic_unique',
  'metrics.lifetime.video_views_p95_paid': 'video_views_p95_paid',
  'metrics.lifetime.video_views_p95_paid_unique': 'video_views_p95_paid_unique',
  'metrics.lifetime.video_views_paid': 'video_views_paid',
  'metrics.lifetime.video_views_paid_unique': 'video_views_paid_unique',
  'metrics.lifetime.video_views_partial': 'video_views_partial',
  'metrics.lifetime.video_views_partial_autoplay': 'video_views_partial_autoplay',
  'metrics.lifetime.video_views_partial_click_to_play': 'video_views_partial_click_to_play',
  'metrics.lifetime.video_views_partial_organic': 'video_views_partial_organic',
  'metrics.lifetime.video_views_partial_paid': 'video_views_partial_paid',
  'metrics.lifetime.video_views_sound_off': 'video_views_sound_off',
  'metrics.lifetime.video_views_sound_on': 'video_views_sound_on',
  'metrics.lifetime.video_views_unique': 'video_views_unique',
  'metrics.lifetime.impressions': 'impressions',
  'metrics.lifetime.impressions_follower': 'impressions_follower',
  'metrics.lifetime.impressions_follower_unique': 'impressions_follower_unique',
  'metrics.lifetime.impressions_nonfollower': 'impressions_nonfollower',
  'metrics.lifetime.impressions_nonviral': 'impressions_nonviral',
  'metrics.lifetime.impressions_nonviral_unique': 'impressions_nonviral_unique',
  'metrics.lifetime.impressions_organic': 'impressions_organic',
  'metrics.lifetime.impressions_organic_unique': 'impressions_organic_unique',
  'metrics.lifetime.impressions_paid': 'impressions_paid',
  'metrics.lifetime.impressions_paid_unique': 'impressions_paid_unique',
  'metrics.lifetime.impressions_unique': 'impressions_unique',
  'metrics.lifetime.impressions_viral': 'impressions_viral',
  'metrics.lifetime.impressions_viral_unique': 'impressions_viral_unique',
...
post_df = post_df[[
  ...
  'post_content_clicks',
  'post_content_clicks_unique',
  'post_link_clicks',
  'post_link_clicks_unique',
  'post_other_clicks_unique',
  'post_photo_view_clicks',
  'post_photo_view_clicks_unique',
  'post_video_play_clicks',
  'post_video_play_clicks_unique',
  'reactions',
  'reactions_angry',
  'reactions_haha',
  'reactions_love',
  ...
  'video_views_p95',
  'video_views_p95_organic',
  'video_views_p95_organic_unique',
  'video_views_p95_paid',
  'video_views_p95_paid_unique',
  'video_views_paid',
  'video_views_paid_unique',
  'video_views_partial',
  ...
  'video_views_unique',
  'impressions',
  'impressions_follower',
  'impressions_follower_unique',
  'impressions_nonfollower',
...
# doing the truncate and load of the target table in SF
    with sf_engine.begin() as connection:
        ...
        copy_into_query = f'''
        COPY INTO "{DB}"."{snowflake_schema}"."{TARGET_TABLE}"("INGESTION_TIMESTAMP", "CREATED_TIME", "CUSTOMER_PROFILE_ID", "POST_TYPE", "NETWORK", "LONG_URL", "SHORT_URL", "HASHTAGS", "POST_CONTENT_CLICKS_OTHER", "POST_CONTENT_CLICKS", "POST_CONTENT_CLICKS_UNIQUE", "POST_LINK_CLICKS", "POST_LINK_CLICKS_UNIQUE", "POST_OTHER_CLICKS_UNIQUE", "POST_PHOTO_VIEW_CLICKS", "POST_PHOTO_VIEW_CLICKS_UNIQUE", "POST_VIDEO_PLAY_CLICKS", "POST_VIDEO_PLAY_CLICKS_UNIQUE", "REACTIONS", "REACTIONS_ANGRY", "REACTIONS_HAHA", "REACTIONS_LOVE", "REACTIONS_SAD", "REACTIONS_WOW", "SHARES_COUNT", "LIKES", "COMMENTS_COUNT", "VIDEO_VIEW_TIME", "VIDEO_VIEW_TIME_ORGANIC", "VIDEO_VIEW_TIME_PAID", "VIDEO_VIEW_TIME_PER_VIEW", "VIDEO_VIEWS", "VIDEO_VIEWS_10S", "VIDEO_VIEWS_10S_AUTOPLAY", "VIDEO_VIEWS_10S_CLICK_TO_PLAY", "VIDEO_VIEWS_10S_ORGANIC", "VIDEO_VIEWS_10S_PAID", "VIDEO_VIEWS_10S_SOUND_OFF", "VIDEO_VIEWS_10S_SOUND_ON", "VIDEO_VIEWS_10S_UNIQUE", "VIDEO_VIEWS_30S_COMPLETE", "VIDEO_VIEWS_30S_COMPLETE_AUTOPLAY", "VIDEO_VIEWS_30S_COMPLETE_CLICK_TO_PLAY", "VIDEO_VIEWS_30S_COMPLETE_ORGANIC", "VIDEO_VIEWS_30S_COMPLETE_PAID", "VIDEO_VIEWS_30S_COMPLETE_UNIQUE", "VIDEO_VIEWS_AUTOPLAY", "VIDEO_VIEWS_CLICK_TO_PLAY", "VIDEO_VIEWS_ORGANIC", "VIDEO_VIEWS_ORGANIC_UNIQUE", "VIDEO_VIEWS_P95", "VIDEO_VIEWS_P95_ORGANIC", "VIDEO_VIEWS_P95_ORGANIC_UNIQUE", "VIDEO_VIEWS_P95_PAID", "VIDEO_VIEWS_P95_PAID_UNIQUE", "VIDEO_VIEWS_PAID", "VIDEO_VIEWS_PAID_UNIQUE", "VIDEO_VIEWS_PARTIAL", "VIDEO_VIEWS_PARTIAL_AUTOPLAY", "VIDEO_VIEWS_PARTIAL_CLICK_TO_PLAY", "VIDEO_VIEWS_PARTIAL_ORGANIC", "VIDEO_VIEWS_PARTIAL_PAID", "VIDEO_VIEWS_SOUND_OFF", "VIDEO_VIEWS_SOUND_ON", "VIDEO_VIEWS_UNIQUE", "IMPRESSIONS", "IMPRESSIONS_FOLLOWER", "IMPRESSIONS_FOLLOWER_UNIQUE", "IMPRESSIONS_NONFOLLOWER", "IMPRESSIONS_NONVIRAL", "IMPRESSIONS_NONVIRAL_UNIQUE", "IMPRESSIONS_ORGANIC", "IMPRESSIONS_ORGANIC_UNIQUE", "IMPRESSIONS_PAID", "IMPRESSIONS_PAID_UNIQUE", "IMPRESSIONS_UNIQUE", "IMPRESSIONS_VIRAL", "IMPRESSIONS_VIRAL_UNIQUE", "TAG_ID", "POST_URL", "TAGS")
        FROM 
                's3://{bucket}/'
    ...
    return '\n:::END OF Customer Post Data Ingestion For Facebook Extract Load script:::' 
