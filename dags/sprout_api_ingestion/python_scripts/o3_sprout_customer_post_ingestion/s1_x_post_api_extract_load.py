'''
This python script picks and loads X/Twitter POST Data from SPROUT API creates a equivalent csv file and puts it to S3
...
if os.environ['ENVIRONMENT'] == 'prd':
    ...
    key =  'test/dt='+date+'/x_post_data.csv' 
...
col_list = [
  ...
  'metrics.lifetime.post_detail_expand_clicks',
  'metrics.lifetime.post_hashtag_clicks',
  'metrics.lifetime.post_link_clicks',
  'metrics.lifetime.post_media_clicks',
  'metrics.lifetime.post_profile_clicks',
  ...
  'metrics.lifetime.engagements_other',
  'metrics.lifetime.impressions',
  'metrics.lifetime.post_app_engagements',
  'metrics.lifetime.post_followers_gained',
  'metrics.lifetime.post_followers_lost',
  'internal.tags',
  'perma_link'
]
...
post_df.rename(columns={
  ...
  'metrics.lifetime.post_detail_expand_clicks': 'post_detail_expand_clicks',
  'metrics.lifetime.post_hashtag_clicks': 'post_hashtag_clicks',
  'metrics.lifetime.post_link_clicks': 'post_link_clicks',
  'metrics.lifetime.post_media_clicks': 'post_media_clicks',
  'metrics.lifetime.post_profile_clicks': 'post_profile_clicks',
  ...
  'metrics.lifetime.engagements_other': 'engagements_other',
  'metrics.lifetime.impressions': 'impressions',
  'metrics.lifetime.post_app_engagements': 'post_app_engagements',
  'metrics.lifetime.post_followers_gained': 'post_followers_gained',
  'metrics.lifetime.post_followers_lost': 'post_followers_lost',
...
# doing the truncate and load of the target table in SF
    with sf_engine.begin() as connection:
        ...
        copy_into_query = f'''
        COPY INTO "{DB}"."{snowflake_schema}"."{TARGET_TABLE}"("INGESTION_TIMESTAMP", "CREATED_TIME", "CUSTOMER_PROFILE_ID", "POST_TYPE", "NETWORK", "LONG_URL", "SHORT_URL", "HASHTAGS", "POST_CONTENT_CLICKS", "POST_CONTENT_CLICKS_OTHER", "POST_DETAIL_EXPAND_CLICKS", "POST_HASHTAG_CLICKS", "POST_LINK_CLICKS", "POST_MEDIA_CLICKS", "POST_PROFILE_CLICKS", "REACTIONS", "SHARES_COUNT", "LIKES", "COMMENTS_COUNT", "VIDEO_VIEWS", "ENGAGEMENTS_OTHER", "IMPRESSIONS", "POST_APP_ENGAGEMENTS", "POST_FOLLOWERS_GAINED", "POST_FOLLOWERS_LOST", "TAG_ID", "POST_URL", "TAGS")
        FROM 
                's3://{bucket}/'
    ...
    return '\n:::END OF Customer Post Data Ingestion For X/Twitter Extract Load script:::'  
